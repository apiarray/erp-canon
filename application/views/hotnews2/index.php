    ...
    <div class="modal-content">
      ...
      <form action="<?= base_url('hot_news2/tambah'); ?>" method="post" enctype="multipart/form-data" >
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="nama">Masukkan Tanggal</label>
            <input class="form-control"
            type="text" value="<?php echo date("d-m-Y"); ?>" name="tgl" placeholder="" />
            <div class="invalid-feedback">
          ...
          <div class="form-group">
                 <label for="jabatan">Nama Mitra</label>
          ...
          <!-- <div class="form-group">
            ...
            <input class="form-control <?
            //php echo form_error('gudang') ? 'is-invalid':'' ?>"
            type="text" name="gudang" placeholder="Masukkan gudang" value="<
              //?= $this->session->userdata('gudang'); ?>" readonly />
            <div class="invalid-feedback">
              <?
          ...
          <!-- <div class="form-group">
            ...
            <input class="form-control <?
            //php echo form_error('manager') ? 'is-invalid':'' ?>"
