                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="<?php echo base_url(); ?>daftar_mitra/edit?id=<?= $daf['id']; ?>" class="btn btn-success" style="margin-left:42px"><i class="fa fa-edit"></i>Edit</i></a>
                                                <a href="<?= base_url(); ?>daftar_mitra/hapus/<?= $daf['id']; ?>" class="btn btn-danger mt-2" style="margin-left:35px" onclick="return confirm('Yakin ingin dihapus?');"><i class="fa fa-trash"></i>Hapus</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
