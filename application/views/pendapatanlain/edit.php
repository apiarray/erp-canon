            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" required value="<?= $pendapatanlain['kode_jurnal'];?>" name="kode_jurnal" class="form-control">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-5 text-right">
                    <div class="form-group mb-4">
                        <h5 for=""><b>Jumlah Total : <span id="jumlah_total"><?= $pendapatanlain['jumlah_total'] ?></span></b></h5>
