...
class Jurnalsaldoawal extends CI_Controller {
    ...
    public function index() {
        $topik['judul'] = 'Halaman Menu Saldo Awal';
		...
		$data['saldoawal'] = $this->M_setup_jurnal->tampil_data();
        $this->load->view('templates/header',$topik);
        $this->load->view('saldoawal/index', $data);
